...
export const CONTACT_TTL_MS = 30 * 60 * 1000;    // §6.7: contact invites get 30 minutes
export const PLAINTEXT_RETENTION_CAP_MS = 24 * 3600 * 1000; // §14: plaintext messages live ≤24h
